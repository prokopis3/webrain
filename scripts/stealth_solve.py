#!/usr/bin/env python3
"""stealth_solve.py — real-Chrome stealth sidecar for webrain.

Canonical dev copy. The self-contained marketplace skill keeps its own snapshot
at skills/webrain/scripts/stealth_solve.py — keep both in sync when editing.
