...
| Entire site / follow links | `webrain_spider` | BFS/DFS crawl. Args: `allow`/`deny` URL regex (prune /cart, /login, images at crawl time), `retry`, `delay_ms`, `crawl_timeout_secs`. |
