...
description: The 16-tool consolidated MCP surface (63 legacy capabilities folded via map_surface), grouped and verbatim.
---

# Tools Reference

All 16 tools are discovered dynamically — `webrain_guide` lists them for the
