...
<div className="landing">
            ...
            <div className="term workflow-term">
              ...
              <div className="term-body wf-body">
                ...
                <div className="wf-group" style={{ '--i': 2 }}>
                  ...
                  <div className="term-line wf-line"><span className="term-ok">✓</span><span>challenge turnstile → solved · sidecar</span></div>
                </div>
                <div className="wf-group" style={{ '--i': 3 }}>
      ...
      <div className="bento">
        ...
        <div className="shell">
          <div className="core">
            ...
            <p>Autoschema probes the DOM, then schema, regex, table, JSON-LD, and BM25 modes return clean data. Zero LLM, zero cost.</p>
  ...
  {/* Benchmark — counters + extraction visual */}
  <div className="wrap">
    <div className="section" style={{ paddingBottom: '2rem' }}>
      <div className="section-head">
        <h2>Fast enough that the agent finishes before the tab does.</h2>
        <p>Representative session figures from the built-in agent loop, plus the extraction benchmark across engines.</p>
      </div>
      <div className="bench-stats">
        <div className="bench-stat"><b data-count="42"><span className="num">0</span></b><span>products in 1.4s, one command</span></div>
        <div className="bench-stat"><b data-count="3"><span className="num">0</span></b><span>browser engines, one binary</span></div>
        <div className="bench-stat"><b data-count="15"><span className="num">0</span></b><span>intent-based MCP tools</span></div>
        <div className="bench-stat"><b data-count="100"><span className="num">0</span><em>×</em></b><span>faster than a full browser on static HTML</span></div>
      </div>
      <div className="benchmark-visual">
        <img src="/images/landing/benchmark-art.png" alt="webrain extraction benchmark across engines" />
      </div>
    </div>
  </div>
